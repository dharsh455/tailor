...
def measurement_page():
    return render_template('measurement.html')  # Render measurement.html
...
@app.route('/')
def home():
    return render_template('index.html')  # Flask will look for this file inside the 'templates' folder
